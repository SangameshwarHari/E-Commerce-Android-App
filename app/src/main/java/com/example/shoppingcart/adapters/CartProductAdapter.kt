...
import com.example.shoppingcart.databinding.CartProductItemBinding
import com.example.shoppingcart.databinding.SpecialRvItemBinding
    ...
    inner class CartProductsViewHolder(val binding: CartProductItemBinding):RecyclerView.ViewHolder(binding.root){
        fun bind(cartProduct: CartProduct) {
            binding.apply{
                ...
                tvCartProductQuantity.text=cartProduct.product.price.toString()
