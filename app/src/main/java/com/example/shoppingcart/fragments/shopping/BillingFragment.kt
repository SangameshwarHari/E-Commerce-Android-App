...
import com.example.shoppingcart.adapters.BillingProductsadapter
...
import com.example.shoppingcart.data.order.OrderStatus
import com.example.shoppingcart.databinding.FragmentBillingBinding
import com.example.shoppingcart.util.HorizontalItemDecoration
import com.example.shoppingcart.util.Resource
import com.example.shoppingcart.viewmodel.BillingViewModel
import com.example.shoppingcart.viewmodel.OrderViewModel
...
class BillingFragment:Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.imageAddAddress.setOnClickListener {
            findNavController().navigate(R.id.action_billingFragment_to_addressFragment2)
        }
